...
#define STY32C2_CLINT_MSIP(hart) \
    (STY32C2_CLINT_BASE + CLINT_MSIP_BASE + (4 * hart))
...
#define RISCV_CLINT_MSIP(hart)  STY32C2_CLINT_MSIP(hart)
#define RISCV_IPI          	    STY32C2_CLINT_MSIP(0)
