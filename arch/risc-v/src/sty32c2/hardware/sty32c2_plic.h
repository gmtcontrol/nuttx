...
#define STY32C2_PLIC_PENDING(interrupt) \
    (STY32C2_PLIC_BASE + PLIC_PENDING_BASE + (PLIC_PRIORITY_BASE * interrupt))

#define STY32C2_PLIC_ENABLE(hart, mode) \
    (STY32C2_PLIC_BASE + PLIC_ENABLE_BASE + (PLIC_ENABLE_STRIDE * hart))

#define STY32C2_PLIC_THRESHOLD(hart, mode) \
    (STY32C2_PLIC_BASE + PLIC_CONTEXT_BASE + (PLIC_CONTEXT_STRIDE * hart))
