/****************************************************************************
 * arch/renesas/src/arm/ra6m5_usbdev.c
 *
...
#define RA6M5_ENDP_BIT(ep)    (1 << (ep))
#define RA6M5_ENDP_ALLSET     0xff

#define RA6M5_MAXPACKET_SHIFT (6)
#define RA6M5_MAXPACKET_SIZE  (1 << (RA6M5_MAXPACKET_SHIFT))
#define RA6M5_MAXPACKET_MASK  (RA6M5_MAXPACKET_SIZE-1)

#define RA6M5_EP0MAXPACKET    RA6M5_MAXPACKET_SIZE
...
#define RA6M5_TRACEERR_ALLOCFAIL         0x0001
#define RA6M5_TRACEERR_ATTACHIRQ         0x0002
#define RA6M5_TRACEERR_BINDFAILED        0x0003
#define RA6M5_TRACEERR_DRIVER            0x0004
#define RA6M5_TRACEERR_DRIVERREGISTERED  0x0005
#define RA6M5_TRACEERR_EPREAD            0x0006
#define RA6M5_TRACEERR_EWRITE            0x0007
#define RA6M5_TRACEERR_INVALIDPARMS      0x0008
#define RA6M5_TRACEERR_NOEP              0x0009
#define RA6M5_TRACEERR_NOTCONFIGURED     0x000a
#define RA6M5_TRACEERR_NULLPACKET        0x000b
#define RA6M5_TRACEERR_NULLREQUEST       0x000c
#define RA6M5_TRACEERR_REQABORTED        0x000d
#define RA6M5_TRACEERR_STALLEDCLRFEATURE 0x000e
#define RA6M5_TRACEERR_STALLEDISPATCH    0x000f
#define RA6M5_TRACEERR_STALLEDGETST      0x0010
#define RA6M5_TRACEERR_STALLEDGETSTEP    0x0011
#define RA6M5_TRACEERR_STALLEDGETSTRECIP 0x0012
#define RA6M5_TRACEERR_STALLEDREQUEST    0x0013
#define RA6M5_TRACEERR_STALLEDSETFEATURE 0x0014
#define RA6M5_TRACEERR_BADGETCONFIG      0x0015
#define RA6M5_TRACEERR_IRQREGISTRATION   0x001a
#define RA6M5_TRACEERR_DISPATCHSTALL     0x001b
#define RA6M5_TRACEERR_INVALIDCTRLREQ    0x001c
#define RA6M5_TRACEERR_BADEPTYPE         0x001d
#define RA6M5_TRACEERR_BADEPNO           0x001e
#define RA6M5_TRACEERR_EPRESERVE         0x001f
#define RA6M5_TRACEERR_BADSETCONFIG      0x0020

/* Trace interrupt codes */

#define RA6M5_TRACEINTID_CLEARFEATURE    0x0001
#define RA6M5_TRACEINTID_CONTROL         0x0002
#define RA6M5_TRACEINTID_DISPATCH        0x0003
#define RA6M5_TRACEINTID_GETENDPOINT     0x0004
#define RA6M5_TRACEINTID_GETIFDEV        0x0005
#define RA6M5_TRACEINTID_GETSETDESC      0x0006
#define RA6M5_TRACEINTID_GETSETIFCONFIG  0x0007
#define RA6M5_TRACEINTID_GETSTATUS       0x0008
#define RA6M5_TRACEINTID_RESUME          0x0009
#define RA6M5_TRACEINTID_SETADDRESS      0x000a
#define RA6M5_TRACEINTID_SETFEATURE      0x000b
#define RA6M5_TRACEINTID_SUSPEND         0x000c
#define RA6M5_TRACEINTID_SYNCHFRAME      0x000d
#define RA6M5_TRACEINTID_TESTMODE        0x000e
#define RA6M5_TRACEINTID_TXFIFOSTALL     0x000f
#define RA6M5_TRACEINTID_GETCONFIG       0x0010
#define RA6M5_TRACEINTID_EPINQEMPTY      0x0011
#define RA6M5_TRACEINTID_EPOUTQEMPTY     0x0012
#define RA6M5_TRACEINTID_NOSTDREQ        0x0013
#define RA6M5_TRACEINTID_SETCONFIG       0x0014
#define RA6M5_TRACEINTID_GETSETIF        0x0015
...
#define RA6M5_BULKMAXPACKET     64          /* Bulk endpoint max packet */
#define RA6M5_INTRMAXPACKET     64          /* Interrupt endpoint max packet */

/* Endpoint numbers */

#define RA6M5_EP0                0          /* Control endpoint */
#define RA6M5_EPBULKIN           1          /* Bulk EP for send to host */
#define RA6M5_EPBULKOUT          2          /* Bulk EP for recv to host */
#define RA6M5_EPINTRIN           3          /* Intr EP for host poll */

/* Request queue operations *************************************************/

#define ra6m5_rqempty(ep)       ((ep)->head == NULL)
#define ra6m5_rqpeek(ep)        ((ep)->head)
...
struct ra6m5_req_s
{
  ...
  struct ra6m5_req_s    *flink;         /* Supports a singly linked list */
};
...
struct ra6m5_ep_s
{
   ...
   * to struct ra6m5_ep_s.
   */

  struct usbdev_ep_s     ep;            /* Standard endpoint structure */

  /* RA6M5-specific fields */

  struct ra6m5_usbdev_s *dev;           /* Reference to private driver data */
  struct ra6m5_req_s    *head;          /* Request list for this endpoint */
  struct ra6m5_req_s    *tail;
...
struct ra6m5_usbdev_s
{
  /* Common device fields.  This must be the first thing defined in the
   * structure so that it is possible to simply cast from struct usbdev_s
   * to struct ra6m5_usbdev_s.
   */
  ...
  struct work_s    ra6m5_interrupt_bhalf;
  struct usb_ctrlreq_s   ctrl;

  /* The endpoint list */

  struct ra6m5_ep_s      eplist[RA6M5_NENDPOINTS];
};

/* For maintaining tables of endpoint info */

struct ra6m5_epinfo_s
{
...
#  define ra6m5_usbdev_getreg8(addr)      getreg8 (RA6M5_USBFS_BASE + (addr))
#  define ra6m5_usbdev_getreg16(addr)     getreg16(RA6M5_USBFS_BASE + (addr))
#  define ra6m5_usbdev_getreg32(addr)     getreg32(RA6M5_USBFS_BASE + (addr))
#  define ra6m5_usbdev_putreg8(val,addr)  putreg8 (val,RA6M5_USBFS_BASE + (addr))
#  define ra6m5_usbdev_putreg16(val,addr) putreg16(val,RA6M5_USBFS_BASE + (addr))
#  define ra6m5_usbdev_putreg32(val,addr) putreg32(val,RA6M5_USBFS_BASE + (addr))

#  define ra6m5_usbdev_getreg_addr(addr)  (RA6M5_USBFS_BASE + (addr))

/* Request queue operations *************************************************/

struct ra6m5_req_s *ra6m5_rqdequeue(struct ra6m5_ep_s *privep);
static void ra6m5_rqenqueue(struct ra6m5_ep_s *privep, struct
                            ra6m5_req_s *req);

/* Low level data transfers and request operations */

static void ra6m5_epwrite(uint8_t epno, struct ra6m5_usbdev_s *priv,
                          struct ra6m5_ep_s *privep, uint8_t *buf,
                          uint32_t nbytes);
static int  ra6m5_epread(uint8_t epno, struct ra6m5_usbdev_s *priv,
                         uint8_t *buf, uint16_t nbytes);
static inline void ra6m5_abortrequest(struct ra6m5_ep_s *privep,
                                      struct ra6m5_req_s *privreq,
                                      int16_t result);
static void ra6m5_reqcomplete(struct ra6m5_ep_s *privep, int16_t result);
static int  ra6m5_wrrequest(uint8_t epno, struct ra6m5_usbdev_s *priv,
                            struct ra6m5_ep_s *privep);
static int  ra6m5_rdrequest(uint8_t epno, struct ra6m5_usbdev_s *priv,
                            struct ra6m5_ep_s *privep);

/* Interrupt handling */

static void ra6m5_dispatchrequest(struct ra6m5_usbdev_s *priv);
void ra6m5_ep0setup(struct ra6m5_usbdev_s *priv);
static int  ra6m5_usbinterrupt(int irq, void *context, void *arg);

/* Endpoint methods */

static int  ra6m5_epconfigure(struct usbdev_ep_s *ep,
                              const struct usb_epdesc_s *desc, bool last);
static int  ra6m5_epdisable(struct usbdev_ep_s *ep);
static struct usbdev_req_s *ra6m5_epallocreq(struct usbdev_ep_s *ep);
static void ra6m5_epfreereq(struct usbdev_ep_s *ep,
                            struct usbdev_req_s *req);
static int  ra6m5_epsubmit(struct usbdev_ep_s *ep,
                           struct usbdev_req_s *privreq);
static int  ra6m5_epcancel(struct usbdev_ep_s *ep,
                           struct usbdev_req_s *privreq);
static void ra6m5_cancelrequests(struct ra6m5_ep_s *privep);

/* USB device controller methods */

static struct usbdev_ep_s *ra6m5_allocep(struct usbdev_s *dev,
                                         uint8_t epno, bool in,
                                         uint8_t eptype);
static void ra6m5_freeep(struct usbdev_s *dev, struct usbdev_ep_s *ep);
static int ra6m5_getframe(struct usbdev_s *dev);
static int ra6m5_wakeup(struct usbdev_s *dev);
static int ra6m5_selfpowered(struct usbdev_s *dev, bool selfpowered);
int ra6m5_pullup(struct usbdev_s *dev, bool enable);
...
{
  .configure   = ra6m5_epconfigure,
  .disable     = ra6m5_epdisable,
  .allocreq    = ra6m5_epallocreq,
  .freereq     = ra6m5_epfreereq,
#ifdef CONFIG_USBDEV_DMA
  .allocbuffer = ra6m5_epallocbuffer,
  .freebuffer  = ra6m5_epfreebuffer,
#endif
  .submit      = ra6m5_epsubmit,
  .cancel      = ra6m5_epcancel,
};
...
{
  .allocep     = ra6m5_allocep,
  .freeep      = ra6m5_freeep,
  .getframe    = ra6m5_getframe,
  .wakeup      = ra6m5_wakeup,
  .selfpowered = ra6m5_selfpowered,
  .pullup      = ra6m5_pullup,
};

enum ra6m5_ep0state_e
{
...
struct ra6m5_usbdev_s g_usbdev;
...
struct ra6m5_req_s *ra6m5_rqdequeue(struct ra6m5_ep_s *privep)
{
  struct ra6m5_req_s *ret = privep->head;
...
static void ra6m5_rqenqueue(struct ra6m5_ep_s *privep,
                            struct ra6m5_req_s *req)
{
  req->flink = NULL;
  if (!privep->head)
    {
...
static void *hw_usb_get_fifoctr_adr(uint16_t pipemode)
{
  ...
  switch (pipemode)
    {
      case USB_CUSE:
        p_reg = (void *)ra6m5_usbdev_getreg_addr(RA6M5_USB_CFIFOCTR_OFFSET);
        break;

      case USB_D0USE:
        p_reg = (void *)ra6m5_usbdev_getreg_addr(RA6M5_USB_D0FIFOCTR_OFFSET);
        break;

      case USB_D1USE:
        p_reg = (void *)ra6m5_usbdev_getreg_addr(RA6M5_USB_D1FIFOCTR_OFFSET);
        break;
...
{
  return ra6m5_usbdev_getreg16(RA6M5_USB_SYSCFG_OFFSET);
}
...
static uint16_t hw_usb_read_dcpmaxp(void)
{
  return ra6m5_usbdev_getreg16(RA6M5_USB_DCPMAXP_OFFSET);
}
...
static void hw_usb_write_fifo16(uint16_t pipemode, uint16_t data)
{
  switch (pipemode)
    {
      case USB_CUSE:
        ra6m5_usbdev_putreg16(data, RA6M5_USB_CFIFO_OFFSET);
        break;
      case USB_D0USE:
        ra6m5_usbdev_putreg16(data, RA6M5_USB_D0FIFO_OFFSET);
        break;
      case USB_D1USE:
        ra6m5_usbdev_putreg16(data, RA6M5_USB_D1FIFO_OFFSET);
        break;
      default :
        break;
  }
...
static void hw_usb_write_fifo8(uint16_t pipemode, uint8_t data)
{
  switch (pipemode)
    {
      case USB_CUSE:
        ra6m5_usbdev_putreg8(data, RA6M5_USB_CFIFO_OFFSET);
        break;
      case USB_D0USE:
        ra6m5_usbdev_putreg8(data, RA6M5_USB_D0FIFO_OFFSET);
        break;
      case USB_D1USE:
        ra6m5_usbdev_putreg8(data, RA6M5_USB_D1FIFO_OFFSET);
        break;
      default :
        break;
    }
...
{
  uint16_t regval;
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_NRDYENB_OFFSET);
  regval |= (1 << pipeno);
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_NRDYENB_OFFSET);
}
...
{
  uint16_t regval;
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_BEMPENB_OFFSET);
  regval |= (1 << pipeno);
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_BEMPENB_OFFSET);
}
...
{
  uint16_t regval;
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_BRDYENB_OFFSET);
  regval |= (1 << pipeno);
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_BRDYENB_OFFSET);
}
...
static uint16_t hw_usb_read_pipecfg(void)
{
  return ra6m5_usbdev_getreg16(RA6M5_USB_PIPECFG_OFFSET);
}
...
uint16_t usb_pstd_chk_configured(void)
{
  ...
  buf = ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET);
...
{
  uint8_t type;
  uint8_t g_buf[RA6M5_MAXPACKET_SIZE];
  type = MSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBREQ_OFFSET));
          ...
          if (type == ACM_GET_LINE_CODING)
            {
              ...
              usb_cstd_set_buf((uint16_t)USB_PIPE0);
              usb_data_read(g_buf, RA6M5_MAXPACKET_SIZE);
            }
          else
            {
              usb_pstd_ctrl_read(nbytes, buf);
...
static inline void ra6m5_abortrequest(struct ra6m5_ep_s *privep,
                                      ...
                                      int16_t result)
{
  usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_REQABORTED),
...
static void ra6m5_reqcomplete(struct ra6m5_ep_s *privep, int16_t result)
{
  ...
  privreq = ra6m5_rqdequeue(privep);
  ...
  if (!privreq)
    {
      ...
      usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_EPINQEMPTY), 0);
      return -ENOENT;
    }
  ...
  for (; ; )
    {
      ...
      ra6m5_epwrite(epno, priv, privep, buf, nbytes);
                           ...
                           struct ra6m5_ep_s *privep)
{
  ...
  if (!privreq)
    {
      usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_EPOUTQEMPTY), 0);
      return OK;
    }
  ...
  buf        = privreq->req.buf + privreq->req.xfrd;
  nbytesread = ra6m5_epread(epno, priv, buf, privep->ep.maxpacket);
  if (nbytesread < 0)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_EPREAD), nbytesread);
      return ERROR;
    }
...
static void ra6m5_dispatchrequest(struct ra6m5_usbdev_s *priv)
{
  ...
  usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_DISPATCH), 0);
  if (priv && priv->driver)
    {
      ...
      if (ret < 0)
        {
          ...
          usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_DISPATCHSTALL), 0);
          priv->stalled = 1;
        }
    }
}
  ...
  for (i = USB_MIN_PIPE_NO; i < (USB_MAX_PIPE_NO + 1); i++)
    {
      ...
      tmp = (ra6m5_usbdev_getreg16(RA6M5_USB_PIPECFG_OFFSET)) &
...
{
  return ra6m5_usbdev_getreg16(RA6M5_USB_DCPCTR_OFFSET);
}
...
void ra6m5_ep0setup(struct ra6m5_usbdev_s *priv)
{
  struct ra6m5_ep_s   *ep0     = &priv->eplist[EP0];
  struct ra6m5_req_s  *privreq = ra6m5_rqpeek(ep0);
  union wb_u           value;
  union wb_u           index;
  union wb_u           len;
  uint8_t              epno;
  ...
  priv->ctrl.type = LSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBREQ_OFFSET));
  priv->ctrl.req  = MSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBREQ_OFFSET));
  priv->ctrl.value[0] = LSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBVAL_OFFSET));
  priv->ctrl.value[1] =  MSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBVAL_OFFSET));
  priv->ctrl.index[0] = LSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBINDX_OFFSET));
  priv->ctrl.index[1]  = MSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBINDX_OFFSET));
  priv->ctrl.len[0] =  LSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBLENG_OFFSET));
  priv->ctrl.len[1]  = MSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBLENG_OFFSET));
  ...
  if ((priv->ctrl.type & USB_REQ_TYPE_MASK) != USB_REQ_TYPE_STANDARD)
    {
      usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_NOSTDREQ), priv->ctrl.type);
  ...
  switch (priv->ctrl.req)
    {
      ...
      case USB_REQ_CLEARFEATURE:
        {
          ...
          usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_CLEARFEATURE),
                   priv->ctrl.type);
      ...
      case USB_REQ_SETFEATURE:
        {
          ...
          usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_SETFEATURE),
                   priv->ctrl.type);
          if (((priv->ctrl.type & USB_REQ_RECIPIENT_MASK) ==
      ...
      case USB_REQ_SETDESCRIPTOR:
...

        {
          ...
          usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_GETCONFIG),
                   priv->ctrl.type);
      ...
      case USB_REQ_SETCONFIGURATION:
        ...
        {
          usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_SETCONFIG), 0);
          if ((priv->ctrl.type & USB_REQ_RECIPIENT_MASK) ==
            ...
            {
              usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_BADSETCONFIG), 0);
              priv->stalled = 1;
            }
        }
        break;
      ...
      case USB_REQ_SETINTERFACE:
...

        {
          ...
          usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_GETSETIF),
                   priv->ctrl.type);
          ra6m5_dispatchrequest(priv);
        }
        break;
      ...
      case USB_REQ_SYNCHFRAME:
        ...
        {
          usbtrace(TRACE_INTDECODE(RA6M5_TRACEINTID_SYNCHFRAME), 0);
        }
        break;

      default:
        {
          usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_INVALIDCTRLREQ),
                   priv->ctrl.req);
...
static void hw_usb_write_pipeperi(uint16_t data)
{
  ra6m5_usbdev_putreg16(data, RA6M5_USB_PIPEPERI_OFFSET);
}
                             ...
                             const struct usb_epdesc_s *desc, bool last)
{
  ...
  if (!ep || !desc)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_INVALIDPARMS), 0);
  ...
  switch (desc->attr & USB_EP_ATTR_XFERTYPE_MASK)
    {
      ...
      default:
        usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_BADEPTYPE),
                 (uint16_t)desc->type);
        return -EINVAL;
  }
...
static int ra6m5_epdisable(struct usbdev_ep_s *ep)
{
  struct ra6m5_ep_s *privep = (struct ra6m5_ep_s *)ep;
  irqstate_t flags;
...
static struct usbdev_req_s *ra6m5_epallocreq(struct usbdev_ep_s *ep)
{
  ...
  privreq = (struct ra6m5_req_s *)kmm_malloc(sizeof(struct ra6m5_req_s));
  if (!privreq)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_ALLOCFAIL), 0);
      return NULL;
    }

  memset(privreq, 0, sizeof(struct ra6m5_req_s));
  return &privreq->req;
}

/****************************************************************************
 * Name: ra6m5_epfreereq
 *
 * Description:
 *   Free an I/O request
 *
...
static void ra6m5_epfreereq(struct usbdev_ep_s *ep, struct usbdev_req_s *req)
{
  struct ra6m5_req_s *privreq = (struct ra6m5_req_s *)req;
#ifdef CONFIG_DEBUG_FEATURES
  if (!ep || !req)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_INVALIDPARMS), 0);
...
static int ra6m5_epsubmit(struct usbdev_ep_s *ep, struct usbdev_req_s *req)
{
  struct ra6m5_req_s *privreq = (struct ra6m5_req_s *)req;
  struct ra6m5_ep_s *privep = (struct ra6m5_ep_s *)ep;
  struct ra6m5_usbdev_s *priv;
  irqstate_t flags;
  uint8_t epno;
  int ret = OK;
  ...
  if (!priv->driver)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_NOTCONFIGURED),
               priv->usbdev.speed);
  ...
  if (privep->stalled)
    {
      ra6m5_abortrequest(privep, privreq, -EBUSY);
   ...
   */
  ...
  else if (epno == EP0)
    {
      ...
      if (!privep->txbusy)
        {
          ret = ra6m5_wrrequest(epno, priv, privep);
          leave_critical_section(flags);
          return OK;
        }
    }
  ...
  /* Handle OUT (host-to-device) requests */
  ...
  else
    {
      ...
      if (priv->rxpending > 0)
        {
          ret = ra6m5_rdrequest(epno, priv, privep);
          priv->rxpending--;
        }
    }
...
/****************************************************************************
 * Name: ra6m5_cancelrequests
 ****************************************************************************/

static void ra6m5_cancelrequests(struct ra6m5_ep_s *privep)
{
  while (!ra6m5_rqempty(privep))
    {
      usbtrace(TRACE_COMPLETE(USB_EPNO(privep->ep.eplog)),
               (ra6m5_rqpeek(privep))->req.xfrd);
      ra6m5_reqcomplete(privep, -ESHUTDOWN);
    }
}
...
static int ra6m5_epcancel(struct usbdev_ep_s *ep, struct usbdev_req_s *req)
{
  struct ra6m5_ep_s *privep = (struct ra6m5_ep_s *)ep;
  irqstate_t flags;
...
/****************************************************************************
 * Name: ra6m5_epreserve
 ****************************************************************************/

static inline struct ra6m5_ep_s *ra6m5_epreserve(struct ra6m5_usbdev_s *priv,
                                                 uint8_t epset)
{
  struct ra6m5_ep_s *privep = NULL;
  irqstate_t flags;
  int epndx = 0;
  ...
  if (epset)
    {
      ...
      for (epndx = 1; epndx < RA6M5_NENDPOINTS; epndx++)
        {
          uint8_t bit = RA6M5_ENDP_BIT(epndx);
          if ((epset & bit) != 0)
            {
...
static struct usbdev_ep_s *ra6m5_allocep(struct usbdev_s *dev, uint8_t epno,
                                         bool in, uint8_t eptype)
{
  struct ra6m5_usbdev_s *priv = (struct ra6m5_usbdev_s *)dev;
  struct ra6m5_ep_s *privep = NULL;
  uint8_t epset = RA6M5_ENDP_ALLSET;
  ...
  if (epno > 0)
    {
      ...
      if (epno >= RA6M5_NENDPOINTS)
        {
          usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_BADEPNO), (uint16_t)epno);
          return NULL;
        }
      ...
      epset = RA6M5_ENDP_BIT(epno);
    }

  /* Check if the selected endpoint number is available */

  privep = ra6m5_epreserve(priv, epset);
  if (!privep)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_EPRESERVE), (uint16_t)epset);
      goto errout;
    }
...
/****************************************************************************
 * Name: ra6m5_epunreserve
 ****************************************************************************/

static inline void
ra6m5_epunreserve(struct ra6m5_usbdev_s *priv, struct ra6m5_ep_s *privep)
{
  irqstate_t flags = enter_critical_section();
  priv->epavail |= RA6M5_ENDP_BIT(USB_EPNO(privep->ep.eplog));
  leave_critical_section(flags);
}
...
static void ra6m5_freeep(struct usbdev_s *dev, struct
                         usbdev_ep_s *ep)
{
  struct ra6m5_usbdev_s *priv;
  struct ra6m5_ep_s *privep;
  ...
  priv   = (struct ra6m5_usbdev_s *)dev;
  privep = (struct ra6m5_ep_s *)ep;
...
{
  int regval;
  regval = (ra6m5_usbdev_getreg16(RA6M5_USB_FRMNUM_OFFSET) & USB_FRMNUM_VAL);
  return regval;
}
...
{
  uint16_t regval;
  regval = ra6m5_usbdev_getreg16 (RA6M5_USB_INTENB0_OFFSET);
  regval |= USB_RSME;
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_INTENB0_OFFSET);
  return OK;
}

/****************************************************************************
 * Name: ra6m5_selfpowered
 *
 * Description:
...
static void hw_usb_write_pipesel(uint16_t data)
{
  ra6m5_usbdev_putreg16(data, RA6M5_USB_PIPESEL_OFFSET);
}
...
static void hw_usb_write_pipecfg(uint16_t data)
{
  ra6m5_usbdev_putreg16(data, RA6M5_USB_PIPECFG_OFFSET);
}
...
static void hw_usb_write_pipemaxp(uint16_t data)
{
  ra6m5_usbdev_putreg16(data, RA6M5_USB_PIPEMAXP_OFFSET);
}
...
static void hw_usb_set_sqclr(uint16_t pipeno)
{
  ...
  if (USB_PIPE0 == pipeno)
    {
      regval = ra6m5_usbdev_getreg16(RA6M5_USB_DCPCTR_OFFSET);
      regval |= USB_SQCLR;
      ra6m5_usbdev_putreg16(regval, RA6M5_USB_DCPCTR_OFFSET);
    }
  else
    {
      p_reg = (uint16_t *)ra6m5_usbdev_getreg_addr(RA6M5_USB_PIPE1CTR_OFFSET + ((pipeno - 1) * 2));
...
static void hw_usb_clear_sts_brdy(uint16_t pipeno)
{
  ra6m5_usbdev_putreg16((~(1 << pipeno)) & USB_PIPE_ALL,
                 RA6M5_USB_BRDYSTS_OFFSET);
}
...
uint16_t usb_pstd_chk_vbsts(void)
{
  ...
  do
    {
      buf1 = ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET);
      up_udelay(10);
      buf2 = ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET);
      up_udelay(10);
      buf3 = ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET);
    }
  while (((buf1 & USB_VBSTS)  !=
          (buf2 & USB_VBSTS)) ||
         ((buf2 & USB_VBSTS)  !=
          (buf3 & USB_VBSTS)));
...
static uint16_t hw_usb_read_dvstctr(void)
{
  ...
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_DVSTCTR0_OFFSET);
...
static void hw_usb_write_dcpcfg(uint16_t data)
{
  ra6m5_usbdev_putreg16(data, RA6M5_USB_DCPCFG_OFFSET);
}
...
static void hw_usb_write_dcpmxps(uint16_t data)
{
  ra6m5_usbdev_putreg16(data, RA6M5_USB_DCPMAXP_OFFSET);
}
...
void usb_pstd_bus_reset(void)
{
  struct ra6m5_usbdev_s *priv = &g_usbdev;
  priv->usbdev.speed = USB_SPEED_FULL;
...
static int hw_usb_read_syssts(void)
{
  ...
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_SYSSTS0_OFFSET);
...
void hw_usb_pclear_sts_resm(void)
{
  ...
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_INTSTS0_OFFSET);
}
...
{
  uint16_t regval;
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_USBREQ_OFFSET);
  return regval;
}
...
uint16_t hw_usb_read_usbval(void)
{
  ...
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_USBVAL_OFFSET);
...
uint16_t hw_usb_read_usbindx(void)
{
  ...
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_USBINDX_OFFSET);
...
uint16_t hw_usb_read_usbleng(void)
{
  ...
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_USBLENG_OFFSET);
...
static uint16_t hw_usb_read_fifo16(uint16_t pipemode)
{
  ...
  switch (pipemode)
    {
       case USB_CUSE:
         data = ra6m5_usbdev_getreg16(RA6M5_USB_CFIFO_OFFSET);
         break;
...
uint16_t usb_pstd_read_data(uint16_t pipe, uint16_t pipemode)
{
  ...
  g_usb_pstd_data_cnt[pipe] = RA6M5_MAXPACKET_SIZE;
      ...
      if (0u != (bitsts & USB_BITSET(i)))
        {
          ...
          if (USB_NULLPTR != g_p_usb_pstd_pipe[i])
            {
              /* Pipe number to FIFO port select */
...
void usb_pstd_brdy_pipe(uint16_t bitsts, struct ra6m5_usbdev_s *priv,
                        struct ra6m5_ep_s *privep, uint16_t epno)
{
  uint32_t nbytes;

  if (USB_BRDY0 == (ra6m5_usbdev_getreg16(RA6M5_USB_BRDYSTS_OFFSET) & USB_BRDY0))
    {
  ...
  else
    {
      ...
      usb_data_read(g_buffer, RA6M5_MAXPACKET_SIZE);
      bytesread = nbytes;

      /* The ra6m5_rdrequest() function is invoked here
...
static uint16_t hw_usb_read_frmnum(void)
{
  return ra6m5_usbdev_getreg16(RA6M5_USB_FRMNUM_OFFSET);
}
...
static void ra6m5_usbdev_bottomhalf(void *arg)
{
  struct ra6m5_usbdev_s *priv = &g_usbdev;
  ...
  if (bottom_half_processing == USB_INT_BRDY)
    {
      ...
      brdysts = ra6m5_usbdev_getreg16(RA6M5_USB_BRDYSTS_OFFSET);
      regval = ra6m5_usbdev_getreg16(RA6M5_USB_PIPECFG_OFFSET);
...
static int ra6m5_usbinterrupt(int irq, void *context, void *arg)
{
  ...
  intenb0 = ra6m5_usbdev_getreg16(RA6M5_USB_INTENB0_OFFSET);

  /* Read Interrupt Status and mask out interrupts that are not enabled. */

  intsts0 = ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET) & intenb0;
  nrdysts = ra6m5_usbdev_getreg16(RA6M5_USB_NRDYSTS_OFFSET);
  bempsts = ra6m5_usbdev_getreg16(RA6M5_USB_BEMPSTS_OFFSET);

  /* Check VBUS */

  if ((intsts0 & USB_VBINT) == USB_VBINT)
    {
      ra6m5_usbdev_putreg16(
          ((~USB_VBINT) & INTSTS0_BIT_VALUES_TO_DETECT),
          RA6M5_USB_INTSTS0_OFFSET);

      if (USB_ATTACH == usb_pstd_chk_vbsts())
        {
          priv->attached = 1;
          connected_times++;
          syslog(LOG_INFO, "NuttX: USB Device Connected. %ld\n",
                 connected_times);
        ...
        {
          priv->attached = 0;
          syslog(LOG_INFO, "NuttX: USB Device Disconnected. %ld\n",
                 connected_times);
  ...
  intsts0 = ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET);
  if ((intsts0 & USB_DVST) == USB_DVST)
    {
      ra6m5_usbdev_putreg16(
          ((~USB_DVST) & INTSTS0_BIT_VALUES_TO_DETECT),
          RA6M5_USB_INTSTS0_OFFSET);
  ...
  intsts0 = ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET);
  if ((intsts0 & USB_CTRT) == USB_CTRT)
    {
      ra6m5_usbdev_putreg16
        (((~USB_CTRT) & INTSTS0_BIT_VALUES_TO_DETECT),
                     RA6M5_USB_INTSTS0_OFFSET);

      stginfo = (uint16_t)(ra6m5_usbdev_getreg16(RA6M5_USB_INTSTS0_OFFSET) & USB_CTSQ);
    ...
    else
      {
        ...
        type = LSBYTE(ra6m5_usbdev_getreg16(RA6M5_USB_USBREQ_OFFSET));
        ra6m5_ep0setup(priv);
  ...
  if (USB_BRDY == (ists0 & USB_BRDY))
    {
      DEBUGVERIFY(work_queue(HPWORK, &g_usbdev.ra6m5_interrupt_bhalf,
                             ra6m5_usbdev_bottomhalf,
                             (void *)USB_INT_BRDY, 0));
    }
  ...
  if ((((intsts0 & intenb0) & USB_NRDY)) == USB_NRDY)
    {
...
void arm_usbinitialize(void)
{
  ...
  memset(priv, 0, sizeof(struct ra6m5_usbdev_s));
  priv->usbdev.ops = &g_devops;
  priv->usbdev.ep0 = &priv->eplist[EP0].ep;
  priv->epavail    = RA6M5_ENDP_ALLSET & ~RA6M5_ENDP_BIT(EP0);

  /* Initialize the endpoint list */

  for (epno = 0; epno < RA6M5_NENDPOINTS; epno++)
    {
      ...
      priv->eplist[epno].ep.maxpacket = RA6M5_MAXPACKET_SIZE;
    }

  /* Select a smaller endpoint size for EP0 */

#if RA6M5_EP0MAXPACKET < RA6M5_MAXPACKET_SIZE
  priv->eplist[EP0].ep.maxpacket = RA6M5_EP0MAXPACKET;
#endif
  ...
  regval = ra6m5_usbdev_getreg16(RA6M5_USB_CFIFOSEL_OFFSET);
  regval |= (USB_MBW_16);
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_CFIFOSEL_OFFSET);

  /* Set MBW bit in D0FIFOSEL register */

  regval = ra6m5_usbdev_getreg16(RA6M5_USB_D0FIFOSEL_OFFSET);
  regval |= (USB_MBW_16);
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_D0FIFOSEL_OFFSET);

  /* Set MBW bit in D1FIFOSEL register */

  regval = ra6m5_usbdev_getreg16(RA6M5_USB_D1FIFOSEL_OFFSET);
  regval |= (USB_MBW_16);
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_D1FIFOSEL_OFFSET);

  /* Set the Interrupt enable bits in INTENB0 register */

  regval = ra6m5_usbdev_getreg16(RA6M5_USB_INTENB0_OFFSET);
  regval |= (USB_BEMPE | USB_BRDYE |
             USB_VBSE  | USB_DVSE  |
             USB_CTRE);
  ra6m5_usbdev_putreg16(regval, RA6M5_USB_INTENB0_OFFSET);

  ret += irq_attach(RA6M5_IRQ_USBFS_INT, ra6m5_usbinterrupt, NULL);
  ret += irq_attach(RA6M5_IRQ_USBFS_RSM, ra6m5_usbinterrupt, NULL);
  if (ret != 0)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_IRQREGISTRATION),
               (uint16_t)RA6M5_IRQ_USBFS_INT);
    }
...
void arm_usbuninitialize(void)
{
  ...
  if (priv->driver)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_DRIVERREGISTERED), 0);
  ...
  up_disable_irq(RA6M5_IRQ_USBFS_INT);
  up_disable_irq(RA6M5_IRQ_USBFS_RSM);
#ifdef CONFIG_USBDEV_DMA
  up_disable_irq(RA6M5_IRQ_USBFS_FIFO0);
  up_disable_irq(RA6M5_IRQ_USBFS_FIFO1);
#endif

  irq_detach(RA6M5_IRQ_USBFS_INT);
  irq_detach(RA6M5_IRQ_USBFS_RSM);
#ifdef CONFIG_USBDEV_DMA
  irq_detach(RA6M5_IRQ_USBFS_FIFO0);
  irq_detach(RA6M5_IRQ_USBFS_FIFO1);
#endif
}
...
int usbdev_register(struct usbdevclass_driver_s *driver)
{
  ...
  if (g_usbdev.driver)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_DRIVER), 0);
      return -EBUSY;
    }
#endif
  ...
  if (ret)
    {
      usbtrace(TRACE_DEVERROR(RA6M5_TRACEERR_BINDFAILED), (uint16_t)-ret);
  ...
  else
    {
      ...
      up_enable_irq(RA6M5_IRQ_USBFS_INT);
      up_enable_irq(RA6M5_IRQ_USBFS_RSM);

      #ifdef CONFIG_USBDEV_DMA
      up_enable_irq(RA6M5_IRQ_USBFS_FIFO0);
      up_enable_irq(RA6M5_IRQ_USBFS_FIFO1);
      #endif
    }
