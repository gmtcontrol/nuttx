/****************************************************************************
 * arch/arm/src/ra6m5/hardware/r7fa6m5bx_icu.h
 *
...
#ifndef __ARCH_ARM_SRC_RA6M5_HARDWARE_R7FA6M5BX_ICU_H
#define __ARCH_ARM_SRC_RA6M5_HARDWARE_R7FA6M5BX_ICU_H
...
#define RA6M5_CPSCU_ICUSARC_OFFSET      0x00000048          /* ICU Security Attribution Register C */
#define RA6M5_CPSCU_ICUSAR_OFFSET(n)    0x0070 + (4*(n))    /* ICU Security Attribution Register [G,H,I] */
#define RA6M5_ICU_IELSR_OFFSET(n)       0x0300 + (4*(n))    /* ICU Event Link Setting Register [0..95] */

#define RA6M5_ICU_REG(r)            (RA6M5_ICU_BASE   + (r))
#define RA6M5_CPSCU_REG(r)          (RA6M5_CPSCU_BASE + (r))

#define RA6M5_ICU_IELSR_REG(n)      (RA6M5_ICU_BASE   + RA6M5_ICU_IELSR_OFFSET(n))
#define RA6M5_CPSCU_ICUSAR_REG(n)   (RA6M5_CPSCU_BASE + RA6M5_CPSCU_ICUSAR_OFFSET(n))
