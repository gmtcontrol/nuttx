/****************************************************************************
 * arch/arm/src/ra6m5/hardware/ra6m5_usb.h
 *
...
#ifndef __ARCH_ARM_SRC_RA6M5_HARDWARE_RA6M5_USB_H
#define __ARCH_ARM_SRC_RA6M5_HARDWARE_RA6M5_USB_H
...
#define USB_GS_HALT         (1)
#define USB_GS_REMOTEWAKEUP (2)
...
#define USB_FRMNUM_VAL      (0x1111111111)
#define USB_PIPE_ALL        (0x3ff)
...
#define RA6M5_USB_SYSCFG_OFFSET         0x0000  /* System Configuration Control Register */
#define RA6M5_USB_SYSSTS0_OFFSET        0x0004  /* System Configuration Status Register 0 */
#define RA6M5_USB_DVSTCTR0_OFFSET       0x0008  /* Device State Control Register 0 */
#define RA6M5_USB_CFIFO_OFFSET          0x0014  /* CFIFO Port Register */
#define RA6M5_USB_D0FIFO_OFFSET         0x0018  /* D0FIFO Port Register */
#define RA6M5_USB_D1FIFO_OFFSET         0x001C  /* D1FIFO Port Register */
#define RA6M5_USB_CFIFOSEL_OFFSET       0x0020  /* CFIFO Port Select Register */
#define RA6M5_USB_CFIFOCTR_OFFSET       0x0022  /* CFIFO Port Control Register */
#define RA6M5_USB_D0FIFOSEL_OFFSET      0x0028  /* D0FIFO Port Select Register  */
#define RA6M5_USB_D1FIFOSEL_OFFSET      0x002C  /* D1FIFO Port Select Register  */
#define RA6M5_USB_D0FIFOCTR_OFFSET      0x002A  /* D0FIFO Port Control Register */
#define RA6M5_USB_D1FIFOCTR_OFFSET      0x002E  /* D1FIFO Port Control Register */
#define RA6M5_USB_INTENB0_OFFSET        0x0030  /* Interrupt Enable Register 0 */
#define RA6M5_USB_INTENB1_OFFSET        0x0032  /* Interrupt Enable Register 1 */
#define RA6M5_USB_BRDYENB_OFFSET        0x0036  /* BRDY Interrupt Enable Register */
#define RA6M5_USB_NRDYENB_OFFSET        0x0038  /* NRDY Interrupt Enable Register */
#define RA6M5_USB_BEMPENB_OFFSET        0x003A  /* BEMP Interrupt Enable Register */
#define RA6M5_USB_INTSTS0_OFFSET        0x0040  /* Interrupt Status Register 0 */
#define RA6M5_USB_INTSTS1_OFFSET        0x0042  /* Interrupt Status Register 1 */
#define RA6M5_USB_BRDYSTS_OFFSET        0x0046  /* BRDY Interrupt Status Register */
#define RA6M5_USB_NRDYSTS_OFFSET        0x0048  /* NRDY Interrupt Status Register */
#define RA6M5_USB_BEMPSTS_OFFSET        0x004A  /* BEMP Interrupt Status Register */
#define RA6M5_USB_FRMNUM_OFFSET         0x004C  /* Frame Number Register   */
#define RA6M5_USB_USBREQ_OFFSET         0x0054  /* USB Request Type Register */
#define RA6M5_USB_USBVAL_OFFSET         0x0056  /* USB Request Value Register */
#define RA6M5_USB_USBINDX_OFFSET        0x0058  /* USB Request Index Register */
#define RA6M5_USB_USBLENG_OFFSET        0x005A  /* USB Request Length Register */
#define RA6M5_USB_DCPCFG_OFFSET         0x005C  /* DCP Configuration Register */
#define RA6M5_USB_DCPMAXP_OFFSET        0x005E  /* DCP Maximum Packet Size Register */
#define RA6M5_USB_DCPCTR_OFFSET         0x0060  /* DCP Control Register */
#define RA6M5_USB_PIPESEL_OFFSET        0x0064  /* Pipe Window Select Register */
#define RA6M5_USB_PIPECFG_OFFSET        0x0068  /* Pipe Configuration Register */
#define RA6M5_USB_PIPEMAXP_OFFSET       0x006C  /* Pipe Maximum Packet Size Register */
#define RA6M5_USB_PIPEPERI_OFFSET       0x006E  /* Pipe Cycle Control Register */
#define RA6M5_USB_PIPE1CTR_OFFSET       0x0070  /* PIPE1 Control Registers */
#define RA6M5_USB_PIPE2CTR_OFFSET       0x0072  /* PIPE2 Control Registers */
#define RA6M5_USB_PIPE3CTR_OFFSET       0x0074  /* PIPE3 Control Registers */
#define RA6M5_USB_PIPE4CTR_OFFSET       0x0076  /* PIPE4 Control Registers */
#define RA6M5_USB_PIPE5CTR_OFFSET       0x0078  /* PIPE5 Control Registers */
#define RA6M5_USB_PIPE6CTR_OFFSET       0x007A  /* PIPE6 Control Registers */
#define RA6M5_USB_PIPE7CTR_OFFSET       0x007C  /* PIPE7 Control Registers */
#define RA6M5_USB_PIPE8CTR_OFFSET       0x007E  /* PIPE8 Control Registers */
#define RA6M5_USB_PIPE9CTR_OFFSET       0x0080  /* PIPE9 Control Registers */
#define RA6M5_USB_PIPE1TRE_OFFSET       0x0090  /* PIPE1 Transaction Counter Enable Register */
#define RA6M5_USB_PIPE1TRN_OFFSET       0x0092  /* PIPE1 Transaction Counter Register */
#define RA6M5_USB_PIPE2TRE_OFFSET       0x0094  /* PIPE2 Transaction Counter Enable Register */
#define RA6M5_USB_PIPE2TRN_OFFSET       0x0096  /* PIPE2 Transaction Counter Register */
#define RA6M5_USB_PIPE3TRE_OFFSET       0x0098  /* PIPE3 Transaction Counter Enable Register */
#define RA6M5_USB_PIPE3TRN_OFFSET       0x009A  /* PIPE3 Transaction Counter Register */
#define RA6M5_USB_PIPE4TRE_OFFSET       0x009C  /* PIPE4 Transaction Counter Enable Register */
#define RA6M5_USB_PIPE4TRN_OFFSET       0x009E  /* PIPE4 Transaction Counter Register */
#define RA6M5_USB_PIPE5TRE_OFFSET       0x00A0  /* PIPE5 Transaction Counter Enable Register */
#define RA6M5_USB_PIPE5TRN_OFFSET       0x00A2  /* PIPE5 Transaction Counter Register */
#define RA6M5_USB_PHYSLEW_OFFSET        0x00F0  /* USB PHY Cross Point Adjustment Register */

/* Register Bitfield Definitions ********************************************/

/*  DnFIFO Port Control Register */

#define USB_DXFIFOCTR_FRDY              (1 << 13)   /* Bit 13: FIFO Port Ready */

/*  DCP Maximum Packet Size Register */

#define USB_DCPMAXP_MXPS_SHIFT          (0)         /* Bits[0:6]: Maximum Packet Size */
#define USB_DCPMAXP_MXPS_MASK           (127 << USB_DCPMAXP_MXPS_SHIFT)
#  define USB_DCPMAXP_MXPS(n)           (((n) << USB_DCPMAXP_MXPS_SHIFT) & USB_DCPMAXP_MXPS_MASK)

/*  Pipe Maximum Packet Size Register */

#define USB_PIPEMAXP_MXPS_SHIFT         (0)         /* Bits[0:10]: Maximum Packet Size */
#define USB_PIPEMAXP_MXPS_MASK          (2047 << USB_PIPEMAXP_MXPS_SHIFT)
#  define USB_PIPEMAXP_MXPS(n)          (((n) << USB_PIPEMAXP_MXPS_SHIFT) & USB_PIPEMAXP_MXPS_MASK)

/*  DnFIFO Port Select Register */

#define USB_DFIFOSEL_BIGEND             (1 << 8)    /* Bit 8 : FIFO Port Endian Control */
#define USB_DFIFOSEL_MBW                (1 << 10)   /* Bit 10: FIFO Port Access Bit Width */

/*  CFIFO Port Control Register */

#define USB_CFIFOCTR_DTLN_SHIFT         (0)         /* Bits[0:8]: Receive Data Length */
#define USB_CFIFOCTR_DTLN_MASK          (511 << USB_CFIFOCTR_DTLN_SHIFT)
#  define USB_CFIFOCTR_DTLN(n)          (((n) << USB_CFIFOCTR_DTLN_SHIFT) & USB_CFIFOCTR_DTLN_MASK)
#define USB_CFIFOCTR_FRDY               (1 << 13)   /* Bit 13: FIFO Port Ready  */
#define USB_CFIFOCTR_BCLR               (1 << 14)   /* Bit 14: CPU Buffer Clear  */
#define USB_CFIFOCTR_BVAL               (1 << 15)   /* Bit 15: Buffer Memory Valid Flag */

/*  Pipe Configuration Register */

#define USB_PIPECFG_EPNUM_SHIFT         (0)         /* Bits[0:3]: Endpoint Number* */
#define USB_PIPECFG_EPNUM_MASK          (15 << USB_PIPECFG_EPNUM_SHIFT)
#  define USB_PIPECFG_EPNUM(n)          (((n) << USB_PIPECFG_EPNUM_SHIFT) & USB_PIPECFG_EPNUM_MASK)

#define USB_PIPECFG_DIR                 (1 << 4)    /* Bit 4 : Transfer Direction */
#define USB_PIPECFG_SHTNAK              (1 << 7)    /* Bit 7 : ipe Disabled at End of Transfer */
#define USB_PIPECFG_TYPE_SHIFT          (14)         /* Bits[14:15]: Transfer Type */
#define USB_PIPECFG_TYPE_MASK           (3 << USB_PIPECFG_TYPE_SHIFT)
#  define USB_PIPECFG_TYPE(n)           (((n) << USB_PIPECFG_TYPE_SHIFT) & USB_PIPECFG_TYPE_MASK)

/*  Interrupt Status Register 0 */

#define USB_INTSTS0_CTSQ_SHIFT          (0)         /* Bits[0:2]: Control Transfer Stage */
#define USB_INTSTS0_CTSQ_MASK           (7 << USB_INTSTS0_CTSQ_SHIFT)
#  define USB_INTSTS0_CTSQ(n)           (((n) << USB_INTSTS0_CTSQ_SHIFT) & USB_INTSTS0_CTSQ_MASK)
#define USB_INTSTS0_VALID               (1 << 3)    /* Bit 3 : USB Request Reception */
#define USB_INTSTS0_DVSQ_SHIFT          (4)         /* Bits[4:6]: Device State */
#define USB_INTSTS0_DVSQ_MASK           (7 << USB_INTSTS0_DVSQ_SHIFT)
#  define USB_INTSTS0_DVSQ(n)           (((n) << USB_INTSTS0_DVSQ_SHIFT) & USB_INTSTS0_DVSQ_MASK)
#define USB_INTSTS0_VBSTS               (1 << 7)    /* Bit 7 : VBUS Input Status */
#define USB_INTSTS0_BRDY                (1 << 8)    /* Bit 8 : Buffer Ready Interrupt Status */
#define USB_INTSTS0_NRDY                (1 << 9)    /* Bit 9 : Buffer Not Ready Interrupt Status */
#define USB_INTSTS0_BEMP                (1 << 10)   /* Bit 10: Buffer Empty Interrupt Status */
#define USB_INTSTS0_CTRT                (1 << 11)   /* Bit 11: Control Transfer Stage Transition Interrupt Status */
#define USB_INTSTS0_DVST                (1 << 12)   /* Bit 12: Device State Transition Interrupt Status */
#define USB_INTSTS0_SOFR                (1 << 13)   /* Bit 13: Frame Number Refresh Interrupt Status */
#define USB_INTSTS0_RESM                (1 << 14)   /* Bit 14: Resume Interrupt Status */
#define USB_INTSTS0_VBINT               (1 << 15)   /* Bit 15: VBUS Interrupt Status */

/*  Interrupt Status Register 1 */

#define USB_INTSTS1_PDDETINT            (1 << 0)    /* Bits 0 : PDDET Detection Interrupt Status Flag */
#define USB_INTSTS1_SACK                (1 << 4)    /* Bits 4 : Setup Transaction Normal Response Interrupt Status */
#define USB_INTSTS1_SIGN                (1 << 5)    /* Bits 5 : Setup Transaction Error Interrupt Status */
#define USB_INTSTS1_EOFERR              (1 << 6)    /* Bits 6 : EOF Error Detection Interrupt Status */
#define USB_INTSTS1_ATTCH               (1 << 11)   /* Bits 11: ATTCH Interrupt Status */
#define USB_INTSTS1_DTCH                (1 << 12)   /* Bits 12: USB Disconnection Detection Interrupt Status */
#define USB_INTSTS1_BCHG                (1 << 14)   /* Bits 14: USB Bus Change Interrupt Status */
#define USB_INTSTS1_OVRCR               (1 << 15)   /* Bits 15: Overcurrent Input Change Interrupt Status */

/*  PIPEn Transaction Counter Enable Register */

#define USB_PIPETRE_TRCLR               (1 << 8)    /* Bits 8 : Transaction Counter Clear */
#define USB_PIPETRE_TRENB               (1 << 9)    /* Bits 9 : Transaction Counter Enable */

/*  CFIFO Port Select Register */

#define USB_CFIFOSEL_ISEL               (1 << 5)    /* Bits 5 : CFIFO Port Access Direction When DCP Is Selected */

#endif /* __ARCH_ARM_SRC_RA6M5_HARDWARE_RA6M5_USB_H */
