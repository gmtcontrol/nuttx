...
#if defined(CONFIG_RA6M5_DTC_SHORT_ADDRESS_MODE) /* Short-address mode */
...
#if defined(CONFIG_RA6M5_DTC_SEQUENCE_TRANSFER_MODE)
/****************************************************************************
...
dtc_err_t ra6m5_dtc_setup_seq_dynamic_transferdata(DTC_HANDLE handle,
...
dtc_err_t ra6m5_dtc_setup_seq_static_transferdata(DTC_HANDLE handle,
                        uint8_t src, uint32_t scfg, uint32_t pdt,
                        uint32_t nseq_transfer, uint8_t nseq);

/****************************************************************************
 * Name: ra6m5_dtc_seq_enable
 *
 * Description:
...
void ra6m5_dtc_seq_enable(DTC_HANDLE handle, uint8_t src);

/****************************************************************************
 * Name: ra6m5_dtc_seq_disable
 *
 * Description:
...
void ra6m5_dtc_seq_disable(DTC_HANDLE handle);
