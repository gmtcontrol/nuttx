/****************************************************************************
 * boards/arm/ra6m5/ek-ra6m5/src/ra6m5_spi.c
 *
                      ...
                      bool selected)
{
  ...
  switch (devid)
  {
    case 0:
      ...
      ra6m5_gpiowrite(GPIO_SPI0_SEL0, !selected);
      #endif
      break;

    case 1:
      #ifdef GPIO_SPI0_SEL1
      ra6m5_gpiowrite(GPIO_SPI0_SEL1, !selected);
      #endif
      break;

    case 2:
      #ifdef GPIO_SPI0_SEL2
      ra6m5_gpiowrite(GPIO_SPI0_SEL2, !selected);
      #endif
      break;

    case 3:
      #ifdef GPIO_SPI0_SEL3
      ra6m5_gpiowrite(GPIO_SPI0_SEL3, !selected);
      #endif
      break;
  }
}
                      ...
                      bool selected)
{
  ...
  switch (devid)
  {
    case 0:
      ...
      ra6m5_gpiowrite(GPIO_SPI1_SEL0, !selected);
      #endif
      break;

    case 1:
      #ifdef GPIO_SPI1_SEL1
      ra6m5_gpiowrite(GPIO_SPI1_SEL1, !selected);
      #endif
      break;

    case 2:
      #ifdef GPIO_SPI1_SEL2
      ra6m5_gpiowrite(GPIO_SPI1_SEL2, !selected);
      #endif
      break;

    case 3:
      #ifdef GPIO_SPI1_SEL3
      ra6m5_gpiowrite(GPIO_SPI1_SEL3, !selected);
      #endif
      break;
  }
}
