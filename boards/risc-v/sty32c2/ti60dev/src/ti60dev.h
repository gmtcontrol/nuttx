/****************************************************************************
 * boards/risc-v/sty32c2/ti60dev/src/ti60dev.h
 *
...
#ifndef __BOARDS_RISCV_STY32C2_TI60DEV_SRC_TI60DEV_H
#define __BOARDS_RISCV_STY32C2_TI60DEV_SRC_TI60DEV_H
...
#if !defined(CONFIG_STY32C2_SDIO) && !defined(CONFIG_STY32C2_SDIO1)
#  undef HAVE_SDMMC
#endif
...
#    define STY32C2_PROCFS_MOUNTPOINT CONFIG_NSH_PROC_MOUNTPOINT
#  else
#    define STY32C2_PROCFS_MOUNTPOINT "/proc"
#  endif
#endif
...
#ifdef HAVE_SDMMC
int ti60dev_sdio_initialize(void);
#endif
...
#ifdef HAVE_SDMMC
bool ti60dev_cardinserted(int slotno);
#endif
...
#ifdef CONFIG_STY32C2_APPLICATION_RAMDISK
int ti60dev_mount_ramdisk(void);
#endif

#endif /* __BOARDS_RISCV_STY32C2_TI60DEV_SRC_TI60DEV_H */
